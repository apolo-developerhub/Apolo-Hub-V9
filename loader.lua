...
local function _init()
    ...
    btn.Activated:Connect(function()
        ...
        if success and res and (res:find("true") or res:find("valid") or res:find("success")) then
            ...
            -- Executa o Hub diretamente (Fusão Total)
            task.spawn(_runHub)
        else
